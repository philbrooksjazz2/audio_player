/*!
** \file WMA_Dec_Emb_x86.h
** Author: Matthew Carlisle
**
** Description:
** DMX Linux base Header file
**
** Copyright (C) 2001-2004 by DMX MUSIC, Inc.
*/
/*
 * $Log: WMA_Dec_Emb_x86.h,v $
 * Revision 1.1.1.1  2006/04/21 16:30:29  pbrooks
 * Initial checkin of embedded player files.
 *
 * Revision 1.1.1.1  2004/11/22 21:26:03  philipb
 * Initial check in of Profusion X code base.
 *
 */
/*
...
//        240 (orig)
//  or 236 (new)
// Not sure reason for hardcode size! pmb 7/6/07 
        240 
 ...
 *
 */
tWMAFileStatus WMAFileDecodeInit (tHWMAFileState phstate, int x);
 ...
 *
 */
tWMAFileStatus WMAFileDecodeData (tHWMAFileState hstate, tWMA_U32 nSamples);
