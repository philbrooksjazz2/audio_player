...
/*
 * $Log: apd.h,v $
 * Revision 1.8  2006/05/23 19:35:17  pbrooks
...
#define APD_MSG_GETTIME         "GetTime"
#define APD_MSG_SETTIME         "SetTime"
#define APD_MSG_GETBITRATE      "GetBitRate"
#define APD_MSG_GETAUDIOPARAMS  "GetAudioParams"
#define APD_MSG_GETERROR        "GetError"
#define APD_MSG_SETEQ           "SetEQ"
#define APD_MSG_GETEQ           "GetEQ"
#define APD_MSG_GETSTATE        "GetState"


#define APD_STATE_PLAY     0
#define APD_STATE_PAUSE    1
#define APD_STATE_STOP     2

static char apd_state[][20] = {"Play","Pause","Stop"};
...
typedef struct _SongInfo{
    ...
    int bitrate;        /* mp3 bitrate */
    int samplerate;     /* 44100 usually */
    int channels;       /* 1 for mono, 2 for stereo */
    int total_sec;      /* total seconds */
    int current_sec;    /* the current second during playback */
} SongInfo;
